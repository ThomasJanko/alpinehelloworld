pipeline {
     ...
     stage('Push image in production and deploy it') {
      ...
      post {
       success {
         slackSend (color: '#00FF00', message: "SUCCESSFUL: Job '${env.JOB_NAME} [${env.BUILD_NUMBER}]' (${env.BUILD_URL}) - PROD URL => https://alpinehelloworld-v92p.onrender.com, STAGING URL => https://alpinehelloworld-5rig.onrender.com")
         }
      failure {
